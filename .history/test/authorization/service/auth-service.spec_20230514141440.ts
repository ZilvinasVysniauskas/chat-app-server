import { IUser, RegisterRequest } from '../../../src/authorization/models/user';
...
describe('Auth Service', () => {
    ...
    describe('loginUser', () => {
        ...
        it('should throw Failed to login if user not found', async () => {
            jest.spyOn(userRepository, 'findUserByEmail').mockResolvedValue(undefined);
            expect(loginUser(loginRequestMock)).rejects.toThrow('Failed to login.');
        });
    });
});
