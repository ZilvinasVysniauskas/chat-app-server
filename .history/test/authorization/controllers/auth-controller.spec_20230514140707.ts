...
const mockedRegisterRequest: RegisterRequest = {
...
describe('Auth Controller', () => {
  ...
  describe('createUser', () => {
    ...
    it('should create a new user when no errors', async () => {
      ...
      expect(authService.registerUser).toHaveBeenCalledWith(mockedRegisterRequest);
  ...
  describe('login', () => {
    ...
    it('should login user when no errors', async () => {
      ...
      expect(authService.loginUser).toHaveBeenCalledWith(mockedRegisterRequest.email, mockedRegisterRequest.password);
